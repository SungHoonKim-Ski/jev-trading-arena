...
TypeSafe의 판단 전용 모델 **Jev**에게 매매 판단을 맡겨 한국·미국 주식을 모의 매매하는 서비스입니다.
...
|---|---|
| 시세 API 연동, 수정주가 처리, 한국·미국 거래일 달력 | 종목 코드만 입력하면 자동 수집 후 DB 캐시 |
...
| 결과 정리, 비교 기준 설정 | 매수 후 보유, 시장 지수(KOSPI, S&P 500) 대비 초과수익을 자동 계산 |
...
**매매 주기**는 매일, 매주, 격주, 매월(1/5/10/21거래일) 중에서 고릅니다. 비중 변화가 10%p 미만이면 거래하지 않습니다.
